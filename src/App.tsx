...
import './App.css';
import {getPokeData, getPokeCaracteristics, getPokeSpeciesData, getFamilyInfos, getFamilyPokeInfos} from './components/Functions';
      ...
      if (init===false) {
        ...
        if (Next===true){
          ...
          while (loadingData || loadingFamilyData ){
            ...
            console.log(loadingData, loadingFamilyData)
            this.getdata(ID);
            console.log(ID)
        ...
        console.log('htlm')
        console.log(familyID[0],familyID[1], familyID)
        console.log(Next)
